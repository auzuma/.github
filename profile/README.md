...
- (2/17/2025) **SQL Generator (sqlgen) 🤖⚡ -  An AI agent that converts user specs into SQL queries whose outputs' analyses are given to the user. (Currently under development, in alpha stage!)**
